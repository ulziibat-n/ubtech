			...
			<div class="container">
				<div class="flex flex-col gap-8 py-20 max-w-lg sm:gap-12">
					<header class="flex flex-col gap-6 items-start">
						...
						<h1 class="max-w-xs text-4xl font-black sm:text-6xl"><?php esc_html_e( 'Хуудас олдсонгүй', 'ulziibat-tech' ); ?></h1>
					</header><!-- .page-header -->
					<div class="flex flex-col gap-8 items-start">
						<p class=""><?php esc_html_e( 'Энэ хуудас олдсонгүй. Устгагдсан эсвэл нэр өөрчлөгдсөн байж магадгүй, эсвэл хэзээ ч байгаагүй байж болно.', 'ulziibat-tech' ); ?></p>
						<a class="inline-flex gap-1.5 justify-center items-center px-4 py-1.5 text-xs text-sm font-bold leading-none text-white bg-lime-500 rounded-full transition-all duration-300 select-none ease-primary hover:bg-lime-600 hover:text-white" href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home">
